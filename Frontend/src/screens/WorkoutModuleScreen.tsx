...
interface WorkoutModuleScreenProps {
    onNavigate?: (screen: 'display' | 'signin' | 'signup' | 'dashboard' | 'gender' | 'verification' | 'personalinfo' | 'fitnessgoal' | 'settings') => void;
}

export default function WorkoutModuleScreen({ onNavigate }: WorkoutModuleScreenProps) {
    return (
        <View style={styles.container}>
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.content}>
                    <Text style={styles.title}>Workout Module</Text>
